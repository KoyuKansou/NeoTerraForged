...
public class RTFFeatures {
	...
	public static final Feature<RTFRandomPatchFeature.Config> RANDOM_PATCH = register("random_patch", new RTFRandomPatchFeature(RTFRandomPatchFeature.Config.CODEC));
